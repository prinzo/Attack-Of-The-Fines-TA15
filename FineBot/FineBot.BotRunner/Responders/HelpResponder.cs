...
namespace FineBot.BotRunner.Responders
{
    public class HelpResponder : IFineBotResponder
    {
        ...
        public BotMessage GetResponse(ResponseContext context)
        {
            ...
            builder.AppendLine();
            builder.AppendLine("@finesbot leaderboard <today|week|month|year|all time>: Leaderboard of the top five users with the most fines for the current day/week/month/year/all time. If no time period is specified, the leaderboard for this year is displayed");
            builder.AppendLine();
