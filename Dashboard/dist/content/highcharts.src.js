	...
	*/
            ...
            init: function (renderer, nodeName) {
                ...
                if (nodeName) {
                    markup = isDiv || nodeName === 'span' || nodeName === 'img' ?
                        markup.join('') : renderer.prepVML(markup);
        ...
        var VMLRendererExtension = { // inherit SVGRenderer
            ...
            init: function (container, width, height, style) {
                ...
                boxWrapper = renderer.createElement(DIV)
                    .css(extend(this.getStyle(style), {
                        position: RELATIVE
                    }));
    ...
    Axis.prototype = {
        ...
        defaultYAxisOptions: {
            ...
            stackLabels: {
                ...
                style: merge(defaultPlotOptions.line.dataLabels.style, {
                    color: '#000000'
                })
            }
        },
        ...
        setOptions: function (userOptions) {
            this.options = merge(
                this.defaultOptions,
                this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions,
    this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side],
        ...
        unsquish: function () {
            ...
            if (horiz) {
                autoRotation = defined(rotationOption) ? [rotationOption] :
    ...
    Axis.prototype.getLogTickPositions = function (interval, min, max, minor) {
        ...
        if (interval >= 0.5) {
            ...
            interval = pick(
                ...
                axis._minorAutoInterval, (realMax - realMin) * tickPixelIntervalOption / (totalPixelLength || 1)
            );
    ...
    Tooltip.prototype = {
        ...
        init: function (chart, options) {
            ...
            this.label = chart.renderer.label('', 0, 0, options.shape || 'callout', null, null, options.useHTML, null, 'tooltip')
                ...
                .css({
                    padding: 0
                }) // Remove it from VML, the padding is applied as an attribute instead (#1117)
            .add()
                .attr({
                    y: -9999
                }); // #2301, #2657
    ...
    verticalCenter
            ...
            if (markerOptions && markerOptions.enabled !== false) {
                ...
                this.legendSymbol = legendSymbol = renderer.symbol(
                    this.symbol, (symbolWidth / 2) - radius,
                    ...
                    if (step && i) {
                        ...
                        if (step === 'right') {
                            ...
                            segmentPath.push(
                                ...
                                lastPoint.plotY, (lastPoint.plotX + plotX) / 2,
                                plotY
                            );
